...
for s in 01 02 03 04 05 06 07 08 09 10 11 12 13 14 15 20 21 22; do
...
# also copy note on sub-08's missing data, so that the note is kept alongside the data
cp /group/mlr-lab/Saskia/ECoG_RSL/src/sub-08_note.txt /group/mlr-lab/Saskia/ECoG_RSL/derivatives/data/sub-08_note.txt
